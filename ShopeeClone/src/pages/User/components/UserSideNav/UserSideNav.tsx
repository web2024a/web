...
export default function UserSideNav() {
  ...
  return (
    <div>
      ...
      <div className='mt-7'>
        <Link to={path.profile} className='mt-4 flex items-center capitalize hover:text-orange '>
        ...
        <Link to={path.changePassword} className=' mt-4 flex items-center capitalize hover:text-orange'>
          <div className='h-[22px] w-[22px] mr-2'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
        ...
        <Link to={path.historyPurchase} className='mt-4 flex items-center capitalize hover:text-orange'>
          <div className='h-[22px] w-[22px] mr-2'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
